...
%struct.anon = type { [4 x i32]*, [1 x i32]*, i32*, i32* }
%struct.xdp_md = type { i32, i32, i32, i32, i32, i32 }
%struct.S = type { i64 }
%struct.ethhdr = type { [6 x i8], [6 x i8], i16 }

@xdp_buzz_hello.____fmt = internal constant [20 x i8] c"Hey there, I'm XDP!\00", align 1, !dbg !0
...
define dso_local i32 @xdp_buzz_hello(%struct.xdp_md* noundef %0) #0 section "xdp_buzz" !dbg !2 {
  ...
  %11 = tail call i64 (i8*, i32, ...) inttoptr (i64 6 to i64 (i8*, i32, ...)*)(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @xdp_buzz_hello.____fmt, i64 0, i64 0), i32 noundef 20) #4, !dbg !181
...
!1 = distinct !DIGlobalVariable(name: "____fmt", scope: !2, file: !3, line: 21, type: !160, isLocal: true, isDefinition: true)
!2 = distinct !DISubprogram(name: "xdp_buzz_hello", scope: !3, file: !3, line: 16, type: !4, scopeLine: 17, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !20, retainedNodes: !117)
!3 = !DIFile(filename: "xdp_buzz_kern.c", directory: "/media/aadhitya/DATA/XCodes/buzzLB/buzz-test", checksumkind: CSK_MD5, checksum: "6f8f12d39c3861e7d9f658952d56fae9")
...
!67 = distinct !DIGlobalVariable(name: "____fmt", scope: !2, file: !3, line: 28, type: !68, isLocal: true, isDefinition: true)
...
!74 = distinct !DIGlobalVariable(name: "____fmt", scope: !2, file: !3, line: 44, type: !75, isLocal: true, isDefinition: true)
!75 = !DICompositeType(tag: DW_TAG_array_type, baseType: !69, size: 184, elements: !76)
!76 = !{!77}
!77 = !DISubrange(count: 23)
!78 = !DIGlobalVariableExpression(var: !79, expr: !DIExpression())
!79 = distinct !DIGlobalVariable(name: "_license", scope: !20, file: !3, line: 49, type: !80, isLocal: false, isDefinition: true)
!80 = !DICompositeType(tag: DW_TAG_array_type, baseType: !70, size: 32, elements: !81)
!81 = !{!82}
!82 = !DISubrange(count: 4)
!83 = !DIGlobalVariableExpression(var: !84, expr: !DIExpression())
!84 = distinct !DIGlobalVariable(name: "my_map", scope: !20, file: !3, line: 13, type: !85, isLocal: false, isDefinition: true)
!85 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !3, line: 8, size: 256, elements: !86)
!86 = !{!87, !90, !95, !97}
!87 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !85, file: !3, line: 9, baseType: !88, size: 64)
!88 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !89, size: 64)
!89 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6, size: 128, elements: !81)
!90 = !DIDerivedType(tag: DW_TAG_member, name: "max_entries", scope: !85, file: !3, line: 10, baseType: !91, size: 64, offset: 64)
!91 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !92, size: 64)
!92 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6, size: 32, elements: !93)
!93 = !{!94}
!94 = !DISubrange(count: 1)
!95 = !DIDerivedType(tag: DW_TAG_member, name: "key", scope: !85, file: !3, line: 11, baseType: !96, size: 64, offset: 128)
!96 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!97 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !85, file: !3, line: 12, baseType: !96, size: 64, offset: 192)
...
!100 = !DIFile(filename: "./../libbpf/src/bpf_helper_defs.h", directory: "/media/aadhitya/DATA/XCodes/buzzLB/buzz-test", checksumkind: CSK_MD5, checksum: "b2cd2382f6759099a049f8375ad49987")
...
!118 = !DILocalVariable(name: "ctx", arg: 1, scope: !2, file: !3, line: 16, type: !7)
!119 = !DILocalVariable(name: "data", scope: !2, file: !3, line: 18, type: !61)
!120 = !DILocalVariable(name: "data_end", scope: !2, file: !3, line: 19, type: !61)
!121 = !DILocalVariable(name: "trace", scope: !2, file: !3, line: 23, type: !122)
!122 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "S", file: !123, line: 1, size: 64, elements: !124)
!123 = !DIFile(filename: "./xdp_buzz.h", directory: "/media/aadhitya/DATA/XCodes/buzzLB/buzz-test", checksumkind: CSK_MD5, checksum: "de24cd6f9720d5a9009d49116f5da71b")
!124 = !{!125}
!125 = !DIDerivedType(tag: DW_TAG_member, name: "time", scope: !122, file: !123, line: 3, baseType: !111, size: 64)
!126 = !DILocalVariable(name: "ret", scope: !2, file: !3, line: 24, type: !6)
!127 = !DILocalVariable(name: "eth", scope: !2, file: !3, line: 30, type: !128)
...
!141 = !DILocalVariable(name: "iph", scope: !2, file: !3, line: 37, type: !142)
...
!160 = !DICompositeType(tag: DW_TAG_array_type, baseType: !69, size: 160, elements: !161)
!161 = !{!162}
...
!169 = !DILocation(line: 18, column: 37, scope: !2)
!170 = !{!171, !172, i64 0}
!171 = !{!"xdp_md", !172, i64 0, !172, i64 4, !172, i64 8, !172, i64 12, !172, i64 16, !172, i64 20}
!172 = !{!"int", !173, i64 0}
!173 = !{!"omnipotent char", !174, i64 0}
!174 = !{!"Simple C/C++ TBAA"}
!175 = !DILocation(line: 18, column: 26, scope: !2)
!176 = !DILocation(line: 18, column: 18, scope: !2)
!177 = !DILocation(line: 19, column: 41, scope: !2)
!178 = !{!171, !172, i64 4}
!179 = !DILocation(line: 19, column: 30, scope: !2)
!180 = !DILocation(line: 19, column: 22, scope: !2)
!181 = !DILocation(line: 21, column: 5, scope: !182)
!182 = distinct !DILexicalBlock(scope: !2, file: !3, line: 21, column: 5)
!183 = !DILocation(line: 23, column: 5, scope: !2)
!184 = !DILocation(line: 23, column: 14, scope: !2)
!185 = !DILocation(line: 25, column: 18, scope: !2)
!186 = !DILocation(line: 25, column: 11, scope: !2)
!187 = !DILocation(line: 25, column: 16, scope: !2)
!188 = !{!189, !190, i64 0}
!189 = !{!"S", !190, i64 0}
!190 = !{!"long long", !173, i64 0}
!191 = !DILocation(line: 26, column: 33, scope: !2)
!192 = !DILocation(line: 26, column: 11, scope: !2)
!193 = !DILocation(line: 27, column: 9, scope: !194)
!194 = distinct !DILexicalBlock(scope: !2, file: !3, line: 27, column: 9)
!195 = !DILocation(line: 27, column: 9, scope: !2)
!196 = !DILocation(line: 28, column: 9, scope: !197)
!197 = distinct !DILexicalBlock(scope: !194, file: !3, line: 28, column: 9)
!198 = !DILocation(line: 28, column: 9, scope: !194)
!199 = !DILocation(line: 31, column: 14, scope: !200)
!200 = distinct !DILexicalBlock(scope: !2, file: !3, line: 31, column: 9)
!201 = !DILocation(line: 31, column: 38, scope: !200)
!202 = !DILocation(line: 31, column: 9, scope: !2)
!203 = !DILocation(line: 30, column: 26, scope: !2)
!204 = !DILocation(line: 34, column: 9, scope: !205)
!205 = distinct !DILexicalBlock(scope: !2, file: !3, line: 34, column: 9)
!206 = !{!207, !208, i64 12}
!207 = !{!"ethhdr", !173, i64 0, !173, i64 6, !208, i64 12}
!208 = !{!"short", !173, i64 0}
!209 = !DILocation(line: 34, column: 33, scope: !205)
!210 = !DILocation(line: 34, column: 9, scope: !2)
!211 = !DILocation(line: 38, column: 38, scope: !212)
!212 = distinct !DILexicalBlock(scope: !2, file: !3, line: 38, column: 9)
!213 = !DILocation(line: 38, column: 61, scope: !212)
!214 = !DILocation(line: 38, column: 9, scope: !2)
!215 = !DILocation(line: 41, column: 14, scope: !216)
!216 = distinct !DILexicalBlock(scope: !2, file: !3, line: 41, column: 9)
!217 = !{!218, !173, i64 9}
...
!219 = !DILocation(line: 41, column: 23, scope: !216)
!220 = !DILocation(line: 41, column: 9, scope: !2)
!221 = !DILocation(line: 44, column: 5, scope: !222)
!222 = distinct !DILexicalBlock(scope: !2, file: !3, line: 44, column: 5)
!223 = !{!218, !172, i64 12}
!224 = !DILocation(line: 46, column: 5, scope: !2)
!225 = !DILocation(line: 47, column: 1, scope: !2)
